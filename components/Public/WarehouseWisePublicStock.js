...
import { fetchDistFACwiseStockPostion, fetchDistrictDDL, fetchMainCategoryService, fetchMasitems, fetchPublicStockitems, ftechItemWHStock } from '../Services/apiService';
...
const WarehouseWisePublicStock = ({ navigation }) => {
    ...
    const fetchStockPos = async () => {
        ...
        try {
            ...
            const response = await ftechItemWHStock(valueYr);
            setData(response);
    ...
    const renderItem = ({ item, index }) => (
        ...
        >
            ...
            <View style={styles.cell}>
                <Text style={styles.cellText}>{item.issueqtY_CFY}</Text>
            </View>
    ...
    return (
        <View style={styles.container}>
            ...
            <Appbar.Header style={styles.headerApp}>
                ...
                <Appbar.Content title="Item Stock vs C.F.Y. Issuance" titleStyle={styles.headerTitle} />
            </Appbar.Header>
...
>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>WH Name</Text>
                <Text style={styles.headerText}>WH Ready</Text>
                <Text style={styles.headerText}>WH UQC</Text>
                <Text style={styles.headerText}>Issued by WH</Text>
...
export default WarehouseWisePublicStock;
