...
import { fetchDistribution, fetchMainCategoryService, fetchNearExpService, fetchPOAlertSummary, fetchPendingToDrop, fetchPendingToPick, fetchWarehouse } from '../Services/apiService';
...
const PendingToPickDrop = ({ navigation }) => {
    ...
    const fetchMainCategory = async () => {
        try {
            ...
            const stockReportDataDDL = await fetchWarehouse(true);
            ...
            <View style={{ marginLeft: 20, marginRight: 20, marginTop: 20 }}>
                <SegmentedButtons
                    ...
                    buttons={[
                        ...
                        {
                            value: 'PTP',
                            label: 'Pending To Pick',
                            icon: 'car-pickup',

                        },
                        {
                            value: 'PTD',
                            label: 'Pending To Drop',
                            icon: 'dump-truck',
...
export default PendingToPickDrop;
