...
import { fetPOReceiptData, fetchMainCategoryService, fetchYear, fetchYearWiseExpired, fetchYearWiseRC } from '../Services/apiService';
...
const YearExpired = ({ navigation }) => {
    ...
    const fetchPOData = async () => {
        ...
        try {
           // alert("click main Cat:"+valueItem);
                const response = await fetchYearWiseExpired(valueItem);
                setData(response);
    ...
    const renderItem = ({ item, index }) => (
        ...
        >
            ...
            <View style={styles.cell}>
                <Text style={styles.cellText}>{item.expvaluegst}</Text>
            </View>
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
            <Title style={styles.header1}><IconIO name="trash-bin-outline" size={25} color="#000000" /> Expired Items with Values (in Cr)</Title>
            </View>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>Exp.<Icon name="rupee" size={15} color="#000000" /></Text>      
            </View>
            <FlatList
                data={data}
