...
import { fetchDiagnosysCount, fetchDistFACwiseStockPostion, fetchDistrictDDL, fetchDistwiseIssuance, fetchFacilityMC, fetchFacilityMCUser, fetchMainCategoryService, fetchMasitems, fetchOPDCountTotal, fetchPublicStockitems, ftechItemWHStock } from '../Services/apiService';
...
const Diagnosys = ({ navigation }) => {
    ...
    const fetchDistwiseIssuanceData = async () => {
        try {
            ...
            const response = await fetchDiagnosysCount(distId, 'Collector', userid,valueYr,'0',valueItem,segmentValue,"0");
            setData(response);
            //alert(data);
        } catch (error) {
            console.error('Error:', error);
    ...
    const renderItem = ({ item, index }) => (
        ...
        >
            ...
            <View style={styles.cell}>
                <Text style={styles.cellText}>{item.pateintType}</Text>
            </View>
            <View style={styles.cell}>
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>Diagnosys</Text>
