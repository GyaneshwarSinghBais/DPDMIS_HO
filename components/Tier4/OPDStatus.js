...
import { fetchDistFACwiseStockPostion, fetchDistrictDDL, fetchDistwiseIssuance, fetchFacilityMC, fetchFacilityMCUser, fetchMainCategoryService, fetchMasitems, fetchOPDCountTotal, fetchPublicStockitems, ftechItemWHStock } from '../Services/apiService';
...
const OPDStatus = ({ navigation }) => {
    ...
    const fetchDistwiseIssuanceData = async () => {
        try {
            ...
            const response = await fetchOPDCountTotal(distId, 'Collector', userid,valueYr,'0',valueItem,segmentValue);
            setData(response);
            //alert(data);
        } catch (error) {
            console.error('Error:', error);
    ...
    const fetchFacilityMCData = async () => {
        try {
         ...
         //   alert("userid: " + userid+"role:"+roleid);
            const ddlData = await fetchFacilityMCUser('0','0','0','0','0',userid,roleid);
    ...
    const renderItem = ({ item, index }) => (
        ...
        >
            ...
            <View style={styles.cell}>
                <Text style={styles.cellText}>{item.nosfac}</Text>
            </View>
            <View style={styles.cell}>
            ...
            <View style={styles.cell}>
                <Text style={styles.cellText}>{item.nosdr}</Text>
            </View>
    ...
    return (
        <View style={styles.container}>
            ...
            {/* <Appbar.Header style={styles.headerApp}>
                ...
                <Appbar.Content title="Patient Distribution (OPD)" titleStyle={styles.headerTitle} />
            </Appbar.Header> */}
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>No's Facility</Text>
                <Text style={styles.headerText}>No's Item</Text>
                <Text style={styles.headerText}>No's Patient</Text>
                <Text style={styles.headerText}>No's Doctor</Text>
